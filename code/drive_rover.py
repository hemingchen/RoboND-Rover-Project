...
class RoverState():
    def __init__(self):
        ...
        self.mode = RoverMode.FORWARD  # Current mode (can be forward or stop)
        ...
        self.prev_samples_collected = 0
        self.next_sample_dists = []
        self.next_sample_angles = []
        self.stuck_counter = 0  # Count the number of steps the rover gets stuck at one location
        self.stuck_in_prev_step = False
        self.stuck_effort_counter = MAX_STUCK_EFFORTS  # Count the number of steps that rover tries to get out of stuck
